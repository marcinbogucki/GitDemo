...
public class PobranieNazwyOknaDziecka {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Set<String>ids=driver.getWindowHandles(); //pobiera otwarte okna (4)
		Iterator<String>it=ids.iterator(); //obiekt do iteracji 
		while (it.hasNext())// dopoki istnieje element
		{
		driver.switchTo().window(it.next()); //przechodzi do okna dziecka
